...
public class Security extends WebSecurityConfigurerAdapter{
		...
		protected void configure(HttpSecurity http) throws Exception{
			...
			//-------------------------------------acessos permitidos somente pelo ADMIN----------------------------------------------
...
//--------------------------------Excessões condições do usuario: não permite o acesso a certas páginas, caso o usuário tentar, será solicitado a senha do admin-------------------------
@Override
